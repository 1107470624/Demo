 ...
 */
public class Clock2 extends View{
    ...
    public Clock2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        /**
         * 这里所有的R.styleable.OOXX,所有的OOXX中，
         前面的名字必须为：styleable中name属性_属性名称
...
//   并且该函数会调用Activity的onResume生命周期，
//   所以在onResume之后可以设置窗体尺寸；
    @Override
