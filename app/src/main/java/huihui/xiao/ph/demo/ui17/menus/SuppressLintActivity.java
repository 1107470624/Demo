package huihui.xiao.ph.demo.ui17.menus;
...
import huihui.xiao.ph.demo.ui17.menus.flyoutmenu.FlyoutMenuView;

public class SuppressLintActivity extends AppCompatActivity {

    private static float BRUSH_SCALE = 16;
    private FlyoutMenuView toolSelectorFlyoutMenu;
    private FlyoutMenuView paletteFlyoutMenu;
    private FlyoutMenuView smileyFlyoutMenu;
    private TextView brushStateTextView;
    private int toolFlyoutMenuSelectionId = 0;
    private int paletteFlyoutMenuSelectionId = 0;
    private int smileyFlyoutMenuSelectionId = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suppress_lint);
        initView();
        ...
        toolSelectorFlyoutMenu.setSelectedMenuItemById(3);
        paletteFlyoutMenu.setSelectedMenuItemById(3);
        smileyFlyoutMenu.setSelectedMenuItemById(3);
    }

    private void initView() {
        toolSelectorFlyoutMenu = (FlyoutMenuView) findViewById(R.id.toolSelectorFlyoutMenu);

        paletteFlyoutMenu = (FlyoutMenuView) findViewById(R.id.paletteFlyoutMenu);

        smileyFlyoutMenu = (FlyoutMenuView) findViewById(R.id.smileyFlyoutMenu);

        brushStateTextView = (TextView) findViewById(R.id.brushStateTextView);
    }
    @Override
    ...
    void configureToolFlyoutMenu() {
        ...
        int toolColor = ContextCompat.getColor(this, R.color.smileyMenuCharColor);
    ...
    protected void onDestroy() {
        super.onDestroy();
        SuppressLintActivity.this.finish();
    }
}
