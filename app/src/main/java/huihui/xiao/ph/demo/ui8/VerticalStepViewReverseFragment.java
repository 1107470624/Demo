...
public class VerticalStepViewReverseFragment extends Fragment
{
    ...
    public void onStart()
    {
        ...
        mSetpview0.setStepsViewIndicatorComplectingPosition(list0.size() - 3)//设置完成的步数
                ...
                .setStepsViewIndicatorCompleteIcon(ContextCompat.getDrawable(getActivity(), R.mipmap.complted))//设置StepsViewIndicator CompleteIcon  未完成
                .setStepsViewIndicatorDefaultIcon(ContextCompat.getDrawable(getActivity(), R.mipmap.default_icon))//设置StepsViewIndicator DefaultIcon 已完成
